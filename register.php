...
<head>
    ...
    <body class="account-pages">
        ...
        <div class="wrapper-page account-page-center">
                              ...
                              <?php } ?>
                                ...
                                <div class="form-group row m-b-20">
                                    <div class="col-12">
                                        ...
                                        <input class="form-control" type="text" id="username" placeholder="" name="fname" value="<?php
                                        if(isset($fname)){
                                          echo $fname;
                                        }
                                        ?>">
                                ...
                                <div class="form-group row m-b-20">
                                    <div class="col-12">
                                        ...
                                        <input class="form-control" type="text" id="emailaddress"  placeholder="" name="email" value="<?php 
                                        if(isset($email)){
                                          echo $email;
                                        }
                                        ?>">
